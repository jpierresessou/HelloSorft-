...
const SUPABASE_SERVICE_KEY = 'REMPLACEZ_ICI_PAR_VOTRE_VRAIE_CLE_SERVICE_ROLE';
    ...
    ws.on('message', async (data) => {
        try {
            ...
            if (msg.type === 'register') {
                ...
                await supabase.from('users').upsert({ phone: userPhone, name: userName, password: msg.password || '' }, { onConflict: 'phone' });
